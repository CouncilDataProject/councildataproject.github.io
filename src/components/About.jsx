  ...
  return (
    <section
      ...
      <article className="mzp-c-article">
        <h1 className="mzp-c-article-title" style={{ marginBottom: '4rem' }}>
        ...
        <p>
          ...
          journalists, activists, researchers, and all members of each community
          we serve with the tools they need to stay informed and hold their
          councilmembers accountable. By combining and simplifying sources of
          information on council meetings and actions, CDP ensures that everyone
          is empowered to participate in local government.
        </p>
        <p>
