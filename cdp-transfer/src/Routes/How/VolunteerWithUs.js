...
export default function VolunteerWithUs() {
  return (
    <div style={styles.container}>
      <Typography variant="h2" style={styles.title}>How to Help</Typography>
      {HowItWorks.howToHelpContentBlocks.map((contentObject, index) => {
        ...
        return (
          <div style={{ width: "80%", minHeight: "350" }}  key={`howToHelpContentBlock_${index}`}>
